...
if __name__ == '__main__':
    mice_data_dir = r'C:\Users\lkokot\Desktop\ETHZ_STAT_MSC\sem_2\stats_lab\CSV_data_files_for_analysis\CSV data files for analysis'
    ...
    mice_data = md.fetch_mouse_data([2934, 1650])
    print(list(mice_data))
    print(mice_data)